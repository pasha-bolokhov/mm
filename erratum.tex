...
{\Large \bf Erratum: Description of the Heterotic String\\[2mm]
 Solutions in the \boldmath{$M$} Model \\[4mm]
[Phys. Rev. D 79, 106001 (2009)]}
\end{center}
...
\]
The affected places are Eq.~(2.28), the second next equation after (2.28)
which determines $ \tgamma $ in terms of parameter $ \delta $, the formula
immediately preceding Eq. (3.14) and anywhere in the text where $ \gamma $ is discussed.
