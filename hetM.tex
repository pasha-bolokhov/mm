...
The theory we start with is  \ntwo SQCD  with the gauge group \sunu  and \ntwo supersymmetry
...
Now the traceless component of the $ \vartheta $ field  is not involved; therefore, we
...
They acquire mass and inverse size of the  order of $\Lambda_{{\rm CP}(N-1)}$. They 
